            ...
            for (int i = 0; i < numOfPlayers; i++) {
                if (!hands.get(i).getCards().isEmpty()) {
                    ...
                    while (!isGofish) {
                        isGofish = true;
                        int numOfAskCard = 0;
                        String valueOfAskCard = "";
                        GoFishCard one = hands.get(0).getCards().get(0);

                        if (i == numOfPlayers - 1) {
                            System.out.println(players.get(0).getPlayerID() + "'s cards: " + hands.get(0).getCards());

                            System.out.println(players.get(i).getPlayerID() + " asks " + players.get(0).getPlayerID()
...
//                            System.out.println(players.get(i + 1).getPlayerID() + "'s cards: "+hands.get(i + 1).getCards());
                            ...
                            System.out.println(players.get(i).getPlayerID() + " asks " + players.get(i + 1).getPlayerID()
                                    + ": do you have any rank of ");
                            String askCard = sc.nextLine();
